...
insert into cliente (cliente_id, cliente_nome, cliente_email) values (cliente_seq.nextval, 'Maria Oliveira Silva', 'maria@teste.com') 
insert into cliente (cliente_id, cliente_nome, cliente_email) values (cliente_seq.nextval, 'Carlos Silva Freitas', 'carlos@teste.com')
